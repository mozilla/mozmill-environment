...
rm -r $ENV_DIR/lib $ENV_DIR/.Python $ENV_DIR/include $ENV_DIR/python-lib/pip*
rm -r $ENV_DIR/bin/activate* $ENV_DIR/bin/python* $ENV_DIR/bin/easy_install* $ENV_DIR/bin/pip*
